...
def dump_profit_day(stocks, q, kType=KQuery.DAY):
    """
...
def dump_profit_month(stocks, q, kType=KQuery.DAY):
    """
...
start_date = Datetime('2017-05-01')
end_date = Datetime('2018-04-01')
day_n = (end_date.datetime() - start_date.datetime()).days
...
for s in stk:
    ...
    db.save_strategy_test(sp_id, s_id, s.code, cwd, per)
